...
Measurements from a well-conducted scientific study should generated  data and associated metadata that is relevant and if possible standardized [1](http://data.research.cornell.edu/content/writing-metadata). ![Figure 1](/posts/Jenkins-Metadata-Introduction/PrimaryData_Meta.png) 
